...
sudo scutil --set ComputerName "Thanh MPB"
sudo scutil --set HostName "tmbp"
sudo scutil --set LocalHostName "tmbp"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "tmbp"
